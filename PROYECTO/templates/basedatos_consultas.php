{% include 'includes/header.php' %}
		...
		<div class="container">
			<div class="titulo font-weight-bold"><i class="fas fa-folder-open"></i> Base de Datos Consultas de Informaci&oacute;n</div>
			<div class="contenido">
				<div class="row text-center">
					<div class="col-md-10 offset-md-1">
						<h4>&iquest;Qu&eacute; consulta desea visualizar en Base de Datos?</h4><hr/>
						<table class="table table-bordered text-center" style="width: 100%">
							<tbody>
								<tr>
									<td>
										<form action="{{ url_for('basedatos_consultas') }}" method="post">
