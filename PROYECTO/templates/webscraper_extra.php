{% include 'includes/header.php' %}
		...
		<div class="container">
			<div class="titulo font-weight-bold"><i class="fas fa-search"></i> Web Scraper Consultas Propia</div>
			<div class="contenido">
				<div class="row text-center">
					<div class="col-md-10 offset-md-1">
						<h4>&iquest;Qu&eacute; consulta desea crear en Web Scraper?</h4><hr/>
						<i>Campos que acepta por el momento: <b>Total, HP, Attack, Defense, Sp. Atk, Sp. Def, Speed</b></i>
						<table class="table table-bordered text-center" style="width: 100%">
							<tbody>
								<tr>
									<td>
										<form action="{{ url_for('webscraper_extra') }}" method="post">
