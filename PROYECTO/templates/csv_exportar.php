{% include 'includes/header.php' %}
		...
		<div class="container">
			<div class="titulo font-weight-bold"><i class="fas fa-file-csv"></i> CSV Exportar</div>
			<div class="contenido">
				<div class="row text-center">
					<div class="col-md-10 offset-md-1">
						<h4>&iquest;En qu&eacute; formato desea descargar el CSV?</h4><hr/>
						<table class="table table-bordered text-center" style="width: 100%">
							<tbody>
								<tr>
									<td>
										<form action="{{ url_for('csv_exportar') }}" method="post">
