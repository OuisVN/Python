{% include 'includes/header.php' %}
		...
		<div class="container">
			<div class="titulo font-weight-bold"><i class="fas fa-file-csv"></i> CSV Procesos de Limpieza</div>
			<div class="contenido">
				<div class="row text-center">
					<div class="col-md-10 offset-md-1">
						<h4>&iquest;Qu&eacute; procesos de limpieza desea realizar en CSV?</h4><hr/>
						<table class="table table-bordered text-center" style="width: 100%">
							<tbody>
								<tr>
									<td>
										<form action="{{ url_for('csv_procesos') }}" method="post">
